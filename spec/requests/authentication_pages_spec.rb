...
describe "authentication" do
  ...
  describe "authorization" do
    describe "for non-signed in users" do
      ...
      describe "in the Users Controller" do
        ...
        describe "submitting to the update action" do
          # This calls the http directly, so we can check for response redirect to signin
          before { put user_path(user) }
          specify { response.should redirect_to(signin_path)}
        end

        describe "visiting the index action" do
        ...
        describe "submitting to the Micropost destroy action" do
          before do
      ...
      describe "when attempting to visit a protected page" do
        ...
        describe "after signing in" do
          it "should redirect to the desired protected page originally tried" do
    ...
    describe "as wrong user trying to change another user's info" do
      let(:user) { FactoryGirl.create(:user) }
